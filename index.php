                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <?php
                      if(isset($_GET['error']) && $_GET['error'] == 1){
                          echo '<p class="text-center small text-danger">Email atau password salah</p>';
                      } elseif(isset($_GET['success']) && $_GET['success'] == 1){
                          echo '<p class="text-center small text-success">Login berhasil</p>';
                      }
                    ?>
                    <p class="text-center small">Masukkan email dan password untuk login</p>
                  </div>

                  <form class="row g-3 needs-validation" id="loginForm" novalidate action="login.php" method="POST">
